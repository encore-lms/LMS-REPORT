...
| 파일 | 기준일 | 대상 | 발행 |
| --- | --- | --- | --- |
| `reports/2026-09-01_마일스톤1_WBS/` | 2026-08-31 | 09-01 주간회의 | 미발행 (로컬 조립본) |
| `reports/2026-08-11_GOV-AI-통합기획/` | 2026-08-10 | 08-11 킥오프 회의 | 미발행 (로컬 조립본) |
...
assets/
  ...
  svcmap.css        서비스 아키텍처 지도 (단계×영역×카드)
...
발행본이 저장소에 있으므로 바로 서빙하면 되고, 그 화면이 곧 배포본이다.
섹션을 고쳤다면 `python3 build.py` 를 먼저 돌린다.
